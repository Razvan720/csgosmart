...
class ArmasController {
    ...
    read(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const armas = yield database_1.default.query('SELECT * FROM ARMAS', [req.body]);
            res.json(armas);
        });
    }
    update(req, res) {
    ...
    readOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const armas = yield database_1.default.query('SELECT * FROM ARMAS WHERE id=?', [req.params.id]);
            res.json(armas);
        });
    }
